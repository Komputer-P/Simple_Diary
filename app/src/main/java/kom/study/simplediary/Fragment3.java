...
public class Fragment3 extends Fragment {
    ...
    public void loadStatData() {
        ...
        for(int i=0; i<recordCount; i++) {
            ...
            AppConstants.println("#" + " -> " + moodName + ", " + moodCount);
        ...
        for(int i=0; i<recordCount; i++) {
            ...
            AppConstants.println("#" + " -> " + weekDay + ", " + moodCount);
        ...
        for(int i=0; i<recordCount; i++) {
            ...
            AppConstants.println("#" + " -> " + monthDate + ", " + moodCount);
            recordsHash.put(monthDate, moodCount);
        }

        ArrayList<Float> dataKey3 = new ArrayList<>();
    ...
    public void setData1(HashMap<String, Integer> dataHash1) {
